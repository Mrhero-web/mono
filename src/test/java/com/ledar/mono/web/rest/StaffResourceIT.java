...
class StaffResourceIT {
    ...
    private static final String DEFAULT_DEPARTMENT_NUM = "AAAAAAAAAA";
    private static final String UPDATED_DEPARTMENT_NUM = "BBBBBBBBBB";
    ...
    void createStaff() throws Exception {
        ...
        assertThat(testStaff.getLoginName()).isEqualTo(DEFAULT_LOGIN_NAME);
        assertThat(testStaff.getLoginPassword()).isEqualTo(DEFAULT_LOGIN_PASSWORD);
    }
    ...
    void putNewStaff() throws Exception {
        ...
        assertThat(testStaff.getLoginName()).isEqualTo(UPDATED_LOGIN_NAME);
        assertThat(testStaff.getLoginPassword()).isEqualTo(UPDATED_LOGIN_PASSWORD);
    }
