...
class PatientResourceIT {
    ...
    private static final Long DEFAULT_ID_NUM = 1L;
    private static final Long UPDATED_ID_NUM = 2L;
    ...
    void createPatient() throws Exception {
        ...
        assertThat(testPatient.getCureId()).isEqualTo(DEFAULT_CURE_ID);
        ...
        assertThat(testPatient.getLoginName()).isEqualTo(DEFAULT_LOGIN_NAME);
        assertThat(testPatient.getLoginPassword()).isEqualTo(DEFAULT_LOGIN_PASSWORD);
    }
    ...
    @Test
    @Transactional
    void checkCureIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = patientRepository.findAll().size();
        // set the field null
        patient.setCureId(null);
    ...
    void getAllPatients() throws Exception {
        ...
        restPatientMockMvc
            ...
            .andExpect(jsonPath("$.[*].idNum").value(hasItem(DEFAULT_ID_NUM.intValue())))
    ...
    void getPatient() throws Exception {
        ...
        restPatientMockMvc
            ...
            .andExpect(jsonPath("$.idNum").value(DEFAULT_ID_NUM.intValue()))
            ...
            .andExpect(jsonPath("$.loginPassword").value(DEFAULT_LOGIN_PASSWORD));
    }
    ...
    void putNewPatient() throws Exception {
        ...
        Patient testPatient = patientList.get(patientList.size() - 1);
        assertThat(testPatient.getCureId()).isEqualTo(UPDATED_CURE_ID);
        ...
        assertThat(testPatient.getLoginName()).isEqualTo(UPDATED_LOGIN_NAME);
        assertThat(testPatient.getLoginPassword()).isEqualTo(UPDATED_LOGIN_PASSWORD);
    }
