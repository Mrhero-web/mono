...
class UserRoleResourceIT {
    ...
    private static final Long UPDATED_USER_ROLE_ID = 2L;
    ...
    public static UserRole createEntity(EntityManager em) {
        UserRole userRole = new UserRole().userRoleId(DEFAULT_USER_ROLE_ID).userId(DEFAULT_USER_ID).roleId(DEFAULT_ROLE_ID);
        return userRole;
    }
    ...
    public static UserRole createUpdatedEntity(EntityManager em) {
        UserRole userRole = new UserRole().userRoleId(UPDATED_USER_ROLE_ID).userId(UPDATED_USER_ID).roleId(UPDATED_ROLE_ID);
        return userRole;
    }
    ...
    void createUserRole() throws Exception {
        ...
        assertThat(testUserRole.getUserRoleId()).isEqualTo(DEFAULT_USER_ROLE_ID);
    ...
    @Test
    @Transactional
    void checkUserRoleIdIsRequired() throws Exception {
    ...
    void getAllUserRoles() throws Exception {
        ...
        restUserRoleMockMvc
            ...
            .andExpect(jsonPath("$.[*].userRoleId").value(hasItem(DEFAULT_USER_ROLE_ID.intValue())))
    ...
    void getUserRole() throws Exception {
        ...
        restUserRoleMockMvc
            ...
            .andExpect(jsonPath("$.userRoleId").value(DEFAULT_USER_ROLE_ID.intValue()))
    ...
    void putNewUserRole() throws Exception {
        ...
        updatedUserRole.userRoleId(UPDATED_USER_ROLE_ID).userId(UPDATED_USER_ID).roleId(UPDATED_ROLE_ID);
        ...
        UserRole testUserRole = userRoleList.get(userRoleList.size() - 1);
        assertThat(testUserRole.getUserRoleId()).isEqualTo(UPDATED_USER_ROLE_ID);
    ...
    void fullUpdateUserRoleWithPatch() throws Exception {
        ...
        partialUpdatedUserRole.userRoleId(UPDATED_USER_ROLE_ID).userId(UPDATED_USER_ID).roleId(UPDATED_ROLE_ID);
