...
public class PatientResource {
    ...
    public ResponseEntity<Patient> partialUpdatePatient(
        ...
        Optional<Patient> result = patientRepository
            ...
            .map(existingPatient -> {
                if (patient.getCureId() != null) {
                    existingPatient.setCureId(patient.getCureId());
                }
                ...
                if (patient.getLoginName() != null) {
                    existingPatient.setLoginName(patient.getLoginName());
                }
                if (patient.getLoginPassword() != null) {
                    existingPatient.setLoginPassword(patient.getLoginPassword());
                }
